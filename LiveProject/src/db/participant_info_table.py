...
def league_participant_info(
    league_id: int, connection=None, PAGE_COUNT=207700, to_json=False
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-db", "--use-db", type=bool, required=False, default=False, help="Save to DB"
    )
