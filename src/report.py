        ...
        def rise_and_fall():
            ...
            for i in range(0,4):
                try:
                    ...
                    participant_name = str(rise_df.iloc[i,:]['entry_name'])
            ...
            for i in range(0,4):
                try: 
                    ...
                    participant_name = str(fall_df.iloc[i,:]['entry_name'])
...
if __name__ == "__main__":
    ...
    if args.dry_run:
        ...
        if test.numb_of_participants() > 5:
            
            output = test.create_report(display=True)
        else:
            print("League has {} participants, not enough to conduct analysis".format(test.numb_of_participants()))
